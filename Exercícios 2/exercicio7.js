...
function numbers(min, max, n, inclusive = false){
    return inclusive ? n >= min && n <= max : n > min && n < max
}

console.log(numbers(10, 100, 50))
console.log(numbers(16, 100, 160))
console.log(numbers(3, 150, 3))
console.log(numbers(3, 150, 3, true))
